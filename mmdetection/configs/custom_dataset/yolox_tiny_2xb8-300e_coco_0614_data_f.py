...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file='/home/cycyang/NIWA/mmdetection/data/20230614_coco_format_annotation_train_f.json',
        data_prefix=dict(img='20230614_train/'),
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True)
        ],
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='20221207_val/'),
        test_mode=True,
...
# resume = True
# resume_from = "work_dirs/yolox_tiny_2xb8-300e_coco/epoch_110.pth"
